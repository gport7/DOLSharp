...
namespace DOL.GS
{
    public class ExtensionNPC : GameNPC
    {
        ...
        private eEmote Emotes = eEmote.Raise;
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            //SayTo(player, "Hello " + player.Name + ", just hand me an vest, glove or boot to have an extension added to it.");
            SayTo(player, "I add extensions. \n\n" + "Hand me a vest, glove, or boots.");
            TurnTo(player, 250);
