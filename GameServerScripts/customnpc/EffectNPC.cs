    ...
    public class EffectNPC : GameNPC
    {
        ...
        public override bool Interact(GamePlayer player)
        {
            if (base.Interact(player))
            {
                ...
                SayTo(player, "I change effects, speeds, and colors.\n\n" +
                                    "Hand me a weapon or piece of armor.");
        ...
        public override bool ReceiveItem(GameLiving source, InventoryItem item)
        {
            ...
            {
                t.Out.SendMessage("You're too far away to give anything to " + GetName(0, false) + ".", eChatType.CT_System, eChatLoc.CL_SystemWindow);
                return false;
            }
